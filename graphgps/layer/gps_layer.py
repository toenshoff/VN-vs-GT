...
from graphgps.optim.utils import GradScaler, dirichlet_energy
...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h,
        ...
        elif global_model_type == "VirtualNode":
    ...
    def forward(self, batch):
        ...
        if self.has_global:
            if self.global_model_type == 'VirtualNode':
                h_global = self.vn(h, batch.batch)
            else:
